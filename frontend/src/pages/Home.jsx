  ...
  return (
    <div className="container" style={{ textAlign: 'center', paddingTop: '80px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', marginTop: '60px', flexWrap: 'wrap' }}>
        <FeatureCard icon="🔍" title="Disease Detection" desc="Upload a leaf photo and detect crop disease instantly using AI." />
        <FeatureCard icon="📈" title="Price Forecasting" desc="Get market price trends to decide the best time to sell." />
        <FeatureCard icon="✅" title="Smart Recommendation" desc="Combined advice — treat now or sell now, based on AI analysis." />
      </div>
    </div>
  );
}
